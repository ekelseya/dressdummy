...
# 1998-07-12 fl   Read/write 16-bit imageuploads as mode I (0.4)
...
# 2008-08-13 fl   Added tRNS support for RGB imageuploads
...
##
# Image plugin for PNG imageuploads.
...
def _save(im, fp, filename, chunk=putchunk):
    ...
    if mode == "P":
        ...
        #
        # attempt to minimize storage requirements for palette imageuploads
