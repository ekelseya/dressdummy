...
# 1998-06-28 fl   Handle I and F imageuploads
...
"""
A simple 2D drawing interface for PIL imageuploads.
<p>
...
class ImageDraw:
    def __init__(self, im, mode=None):
        ...
        :param mode: Optional mode to use for color values.  For RGB
           imageuploads, this argument can be RGB or RGBA (to blend the
        ...
        if mode in ("I", "F"):
            ...
            self.ink = self.draw.draw_ink(-1)
        if mode in ("1", "P", "I", "F"):
            # FIXME: fix Fill2 to properly support matte for I+F imageuploads
            self.fontmode = "1"
        else:
...
def getdraw(im=None, hints=None):
    """
    (Experimental) A more advanced 2D drawing interface for PIL imageuploads,
