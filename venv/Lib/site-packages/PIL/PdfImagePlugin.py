...
# 2004-02-21 fl   Fixes for 1/L/CMYK imageuploads, etc.
# 2004-02-24 fl   Fixes for 1 and P imageuploads.
#
...
##
# Image plugin for PDF imageuploads (output only).
##
    ...
    for imSequence in ims:
        ...
        for im in im_pages:
            ...
            if im.mode == "1":
                ...
                procset = "ImageC"  # color imageuploads
            elif im.mode == "CMYK":
                filter = "DCTDecode"
            ...
            if filter == "ASCIIHexDecode":
                if bits == 1:
                    ...
                    # imageuploads; do things the hard way...
